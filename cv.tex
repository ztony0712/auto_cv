...
\faUniversity Singapore % Contact info
\end{center}

\section*{PERSONAL SUMMARY}
\noindent
Interested in applying machine learning in autonomous systems. Strong project experience in neural network design, robot simulation, and robotic system development. Conducting PhD research of robotics at the National University of Singapore, supervised by \href{https://cde.nus.edu.sg/cee/staff/yeoh-ker-wei-justin/}{Dr. Yeoh Ker-Wei, Justin}. \\
...
\section*{EDUCATION}
\noindent
\textbf{National University of Singapore, Singapore} \hfill Feb. 2025 | Present \\ % University name and location
\textit{Doctor of Philosophy} \hfill   \\
\textit{Supervisor:} \href{https://cde.nus.edu.sg/cee/staff/yeoh-ker-wei-justin/}{Dr. Yeoh Ker-Wei, Justin} \\
\textit{Interests:} Machine Learning in Robotics; Neural Network; Autonomous Systems \\

\noindent
\textbf{National University of Singapore, Singapore} \hfill Aug. 2023 | Feb. 2025 \\ % University name and location
